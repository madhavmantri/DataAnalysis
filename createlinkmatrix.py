...
xltrain = pd.ExcelFile("/home/abhinav/Desktop/23yard/second-attempt/Train3.xlsx")
...
for i in range(shape(linkmatrix)[0]):
	print ''
	for j in range(len(linkmatrix[i])):
		print linkmatrix[i][j],
